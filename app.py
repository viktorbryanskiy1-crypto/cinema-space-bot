...
CACHE_CONFIG = {
    ...
    'api_expire': 120,
    'data_expire': 300,
    'static_expire': 2592000,
    'video_url_cache_time': 21600,
    'default_expire': 300
}
...
def etag_cache(key_generator_func):
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            data_version = get_data_version(cache_key_base)
            cache_key = f"etag_cache_{cache_key_base}_v{data_version}"
...
def get_data_version(cache_key_base):
    ...
    if version is None:
        version = 1
        cache_set(version_key, version, expire=86400)
    return version
...
def increment_data_version(cache_key_base):
    ...
    cache_set(version_key, new_version, expire=86400)
